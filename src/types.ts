...
export interface Problem {
    ...
    input: string | null;
    output: string | null;
    examples: Array<{ name?: string; input?: string; output?: string; description?: string }> | null;
...
export type SubmissionStatus =
    ...
    | 'time_limit_exceeded' | 'memory_limit_exceeded' | 'disk_limit_exceeded'
    | 'memory_leak' | 'pending' | 'compiling' | 'judging' | 'void'
    | 'aborted' | 'skipped' | 'system_error' | 'bad_problem' | 'unknown_error';
